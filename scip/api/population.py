...
def population(session, overlap=None, common_name=None, scientific_name=None, subgroup=None, name=None):
    ...
    with maintain_schema("public, salmon_geometry", session):
        ...
        for result in results:
            res = {}
            for att in ["common_name", "scientific_name", "subgroup", "cu_name", "cu_code", "cu_outlet", "cu_boundary"]:
